...
public class WebTestBase {
	...
	public static void browserOpen(String browser_Name) {
		switch(browser_Name.toLowerCase()) {
			case "chrome":{
				System.setProperty("webdriver.chrome.driver", "C:\\Users\\91960\\git\\repository4\\makeMytrip\\src\\main\\java\\browserDrivers\\chromedriver.exe");
	...
	public static void register(String mobileNumber,String password) {
